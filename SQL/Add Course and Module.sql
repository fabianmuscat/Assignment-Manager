...
CREATE
OR ALTER FUNCTION
[dbo].[GetCourseId](@course NVARCHAR(100))
RETURNS INT
BEGIN
...
VALUES (@module, @semesterNumber, (SELECT dbo.GetCourseId(@course))) COMMIT TRANSACTION;
END TRY
